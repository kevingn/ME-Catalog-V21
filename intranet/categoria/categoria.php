...
if(isset($_POST["btn1"])){
    ...
    if($btn=="Nuevo"){
        ...
        $sql="INSERT INTO categoria VALUES (NULL, '$nom','$des')";
        $cs=mysqli_query($conexion,$sql);
        ...
        $sql="UPDATE categoria SET nombre='$nom', descripcion='$des' WHERE id='$id'";
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <table  class="table table-bordered table-striped" >
                            <tr>
                                <th width="90%"  >
                                    ...
                                    <center>
                                        <form action="categoria.php" method="POST" class="form-search">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" name="txtdes" id="txtdes" maxlength='50'  SIZE="50" value="<?php echo $var2?>" onKeyPress="keynumeros();" placeholder="ingrese aqui una descripcion" >
                        </div>
                        ...
                        <div class="col-md-9 form-group">
                            ...
                            <table class="table table-hover table-bordered table-striped" style="border-collapse:collapse;">
                                  ...
                                  <tbody>
                                        ...
                                        $pame=mysqli_query($conexion,"SELECT * FROM categoria WHERE nombre LIKE '%$buscar%' or id='$buscar' ORDER BY nombre"); 
                                      }else{
                                        $pame=mysqli_query($conexion,"SELECT * FROM categoria ORDER BY nombre");    
                                      }   
                                    ...
                                    <td class="accordian-body collapse <?php echo 'art'.$cont;?>" colspan="2">
                                        <div class="media" style="padding: 10px;">
                                            <div class="col-xs-9 media-right text-right">
                                                    <?php echo "<a href='../../intranet/categoria/categoria.php?id=$row[id]' class='btn btn-primary'>MODIFICAR</a> ";?>
                                                    </form>
                                            </div>
                                        </div>    
                                    </td>
